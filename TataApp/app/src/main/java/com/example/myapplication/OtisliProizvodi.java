...
public class OtisliProizvodi extends SQLiteOpenHelper {
    public static final String DATABASE_NAME="OtisliProizvodi.db";
    ...
    public OtisliProizvodi(@Nullable Context context) {
