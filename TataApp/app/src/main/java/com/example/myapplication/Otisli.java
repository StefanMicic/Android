...
public class Otisli extends AppCompatActivity {
    static String[] Headers = {"Naziv","Kolicina","Datum"};
    TableView<String[]> tableView;
    OtisliProizvodi otisliProizvodi;
    Button brisi;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_otisli);
        ...
        brisi.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Cursor res1 = otisliProizvodi.getAllData();
                        while(res1.moveToNext()){
                            otisliProizvodi.deleteData(res1.getString(1));
                        }
                        NapuniTabelu(tableView);
                    }
                }
    ...
    public void NapuniTabelu(TableView<String[]> tableView){
        ...
        otisliProizvodi = new OtisliProizvodi(this);
        Cursor res= otisliProizvodi.getAllData();
        int row=0;
        ...
        tableView.setDataAdapter(new SimpleTableDataAdapter(Otisli.this,Values));
    }
}
